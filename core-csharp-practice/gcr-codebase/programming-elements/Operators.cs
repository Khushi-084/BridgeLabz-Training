...
class Operators{
  static void Main(string[] args){
    ...
    Console.WriteLine("Modulus: " + (a % b));   // to calculate the remainder
    ...
    Console.WriteLine("Value of a after post-increment: " + a);
    Console.WriteLine("Pre-increment a: " + (++a));
    Console.WriteLine("Value of a after pre-increment: " + a);
    Console.WriteLine("Post-decrement a: " + (a--));
    Console.WriteLine("Value of a after post-decrement: " + a);
    Console.WriteLine("Pre-decrement a: " + (--a));
    Console.WriteLine("Value of a after pre-decrement: " + a);
  }
}